...
type App struct {
	...
	CloudPrivateKey                       crypto.Ed25519PrivateKey `json:"cloudPrivateKey,omitempty"` //nolint: tagliatelle
	CloudPublicKey                        crypto.Ed25519PublicKey  `json:"-"`
...
func (c *Config) Parse(ctx context.Context, configArgs, paths string) errs.Err {
	return config.Parse(ctx, c, "homechart", "", configArgs, paths)
}
