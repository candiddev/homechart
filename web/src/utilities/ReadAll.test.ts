...
])("ReadAll: %s", async (_name: string, responses: XHRResponse[], input: ReadAllArguments<Data>, output: ReadAllResponse<Data> | Err, requests: XHRRequest[]) => {
	testing.mocks.responses = responses;

	expect(await ReadAll(input))
