...
export function AppToolbarActions(): AppToolbarActionAttrs {
  return {
    ...
    newBudgetCategory: {
      ...
      onclick: (): void => {
        AppState.setLayoutAppForm(
          FormOverlayBudgetCategory,
          BudgetMonthCategoryState.new() as Data,
        );
      },
      permitted:
        GlobalState.permitted(PermissionComponentsEnum.Budget, true) &&
    ...
    headerHealth: {
      ...
      permitted:
        GlobalState.permitted(PermissionComponentsEnum.Health, true) &&
    ...
    newInventoryCollection: {
      ...
      onclick: (): void => {
        AppState.setLayoutAppForm(
          FormOverlayInventoryCollection,
    ...
    headerNotes: {
      ...
      permitted:
        GlobalState.permitted(PermissionComponentsEnum.Notes, true) &&
    ...
    headerPlan: {
      ...
      permitted:
        GlobalState.permitted(PermissionComponentsEnum.Plan, true) &&
    ...
    headerReward: {
      ...
      permitted:
        GlobalState.permitted(PermissionComponentsEnum.Reward, true) &&
    ...
    newShopCategory: {
      ...
      permitted:
        GlobalState.permitted(PermissionComponentsEnum.Shop, true) &&
        !GlobalState.hideComponentIncludes("Shop") &&
        AuthHouseholdState.data().length > 0,
      requireOnline: true,
    },
    newShopItem: {
      icon: Icons.ShopItem,
