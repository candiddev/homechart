...
describe("BudgetMonthCategoryState", () => {
  ...
  test("groupingSort", () => {
    ...
    expect(c.targetAmount).toBe(100000);
    expect(output[12]).toStrictEqual({
    ...
    expect(output.reverse()[1]).toStrictEqual(
      seed.budgetMonths[0].budgetMonthCategories[0],
    );
  });
