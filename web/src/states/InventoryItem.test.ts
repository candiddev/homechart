...
describe("InventoryItemState", () => {
	...
	test("findPropertyValues", () => {
		...
		expect(InventoryItemState.findPropertyValues("a"))
			.toStrictEqual([
				"1",
				"2",
			]);
	...
	test("getLink", () => {
		...
		expect(InventoryItemState.getLink("1"))
			.toBe("http://example.com/inventory/all?id=1");
	});
	...
	test("getProperties", () => {
		...
		expect(InventoryItemState.properties())
			.toStrictEqual([
				"Location",
				"a",
				"b",
