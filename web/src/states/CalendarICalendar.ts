...
import { ObjectiCalendarCreated, ObjectiCalendarDeleted, ObjectiCalendarUpdated } from "../yaml8n";
...
class CalendarICalendarManager extends DataArrayManager<CalendarICalendar> {
	constructor () {
		super("/api/v1/calendar/icalendars", "name", false, DataTypeEnum.CalendarICalendar);
	}
