...
describe("HealthLogState", () => {
	...
	test("findAuthAccountID", () => {
		...
		expect(HealthLogState.findAuthAccountID("1")())
			.toHaveLength(2);
		expect(HealthLogState.findAuthAccountID("2")())
			.toHaveLength(1);
	});
	...
	test("findDateRange", async () => {
		...
		expect(HealthLogState.findDateRange(today.toCivilDate(), today.toCivilDate())())
			...
			], today.toCivilDate(), today.toCivilDate()));
	});
});
