...
import { ObjectVersionCreated, ObjectVersionDeleted, ObjectVersionUpdated } from "../yaml8n";
...
class NotesPageVersionManager extends DataArrayManager<NotesPageVersion> {
	constructor () {
		super("/api/v1/notes/page-versions", "updated", true, DataTypeEnum.NotesPageVersion);
	}
