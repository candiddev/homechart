...
describe("CookMealPlanState", () => {
  test("findDateRange", async () => {
    ...
    expect(CookMealPlanState.findDateRange(start, end)()).toStrictEqual(
        ...
        [
          {
            ...
            ...{
              color: "orange",
              cookMealPlans: [CookMealPlanState.data()[0]],
          ...
          },
          {
            ...
            ...{
              color: "orange",
              cookMealPlans: [CookMealPlanState.data()[3]],
              dateStart: "2020-10-17",
              duration: 30,
              icon: Icons.CookMealPlan,
              name: "Lunch",
          ...
          },
          {
            ...
            ...{
              color: "orange",
              cookMealPlans: [CookMealPlanState.data()[4]],
...
1 glass`,
    ...
    expect(
      CookMealPlanState.toShopItems(input).map((item) => {
        item.id = null;
        return item;
      }),
