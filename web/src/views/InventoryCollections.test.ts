...
test("InventoryCollections", async () => {
	...
	testing.text(`#table-data-${seed.inventoryCollections[2].id}-name`, seed.inventoryCollections[2].name);
	testing.text(`#table-data-${seed.inventoryCollections[2].id}-grouping`, seed.inventoryCollections[2].grouping);
	testing.text(`#table-data-${seed.inventoryCollections[2].id}-icon`, seed.inventoryCollections[2].icon);
