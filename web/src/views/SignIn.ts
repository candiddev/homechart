...
import {
  ObjectMessageSent,
  WebGlobalActionShowPassword,
  WebGlobalActionSignIn,
  WebGlobalActionSignInWith,
  WebGlobalActionSignUp,
  WebGlobalActionSignUpWith,
  WebGlobalEmailAddress,
  WebGlobalSelfHostedAddress,
  WebGlobalSelfHostedAddressTooltip,
  WebGlobalTOTPCode,
  WebGlobalTOTPCodeTooltip,
  WebSignInForgotPassword,
  WebSignInLegal1,
  WebSignInLegal2,
  WebSignInLegal3,
  WebSignInLegal4,
  WebSignInLegal5,
  WebSignInReferralCode,
  WebSignInReferralCodeTooltip,
  WebSignInRememberMe,
  WebSignInTryDemo,
} from "../yaml8n";
        ...
        ? m(
            Form,
            {
              ...
              onsubmit: async () => {
                ...
                if (CheckForm("")) {
                  ...
                  if (m.route.get().includes("/signin")) {
                    return AuthAccountState.createSession(
                      ...
                      return GlobalState.signIn().then(async () => {
                  ...
                  if (m.route.get().includes("/signup")) {
            ...
            [
              state.initSelfHosted
                ? []
                : m(
                    "i.SignIn__selfhosted#self-hosted",
                    {
              ...
              m(Logo),
              state.selfHostedServer ||
              (apiEndpoint().hostname !== "" &&
                apiEndpoint().hostname !== "https://web.homechart.app")
                ? m(FormItem, {
                    input: {
              ...
              m(FormItem, {
                input: {
                  ...
                  required: true,
                  type: state.formPasswordVisibility ? "text" : "password",
              ...
              m.route.get().includes("/signin")
                ? m(
                    ...
                    m(
                      "span",
                      AuthAccountState.translate(WebSignInForgotPassword),
                    ),
                  )
                : [],
              m(FormCheckbox, {
              ...
              m(FormCheckbox, {
                ...
                onclick: () => {
                  AuthAccountState.data().rememberMe = !(AuthAccountState.data()
                    .rememberMe as boolean);
                },
                value:
                  AuthAccountState.data().rememberMe === undefined
                    ? false
                    : AuthAccountState.data().rememberMe,
              }),
              AuthAccountState.data().totpEnabled !== undefined &&
              AuthAccountState.data().totpEnabled
                ? m(FormItem, {
                    input: {
              ...
              m("div.SignIn__buttons", [
                m(Button, {
                  name: m.route.get().includes("/signin")
                ...
                InfoState.data().version === "" ? [] : m(Or),
                m(OIDCButtons, {
                  disabled: false,
                  or: true,
                }),
                m(Button, {
                  href: m.route.get().includes("/signin")
                    ? "/signup"
                    : "/signin",
                  name: m.route.get().includes("/signin")
              ...
              m.route.get().includes("/signup")
                ? m(
                    ...
                    [
                      m(
                        "span",
                        `${AuthAccountState.translate(WebSignInLegal1)} ${AuthAccountState.translate(WebGlobalActionSignUp)}, ${AuthAccountState.translate(WebSignInLegal2)} `,
                      ),
                      m(
                        "a.GlobalLink",
                        {
                      ...
                      m(
                        "span",
                        ` ${AuthAccountState.translate(WebSignInLegal4)} `,
                      ),
                      m(
                        "a.GlobalLink",
                        {
