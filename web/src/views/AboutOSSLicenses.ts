...
export function AboutOSSLicenses (): m.Component {
	const state: {
		...
		licenses: [
			...
			{
				licenseLink: "https://github.com/infusion/Fraction.js/blob/master/LICENSE",
				licenseName: "MIT",
			...
			{
				licenseLink: "https://github.com/disintegration/imaging/blob/master/LICENSE",
				licenseName: "MIT",
			...
			{
				licenseLink: "https://github.com/localForage/localForage/blob/master/LICENSE",
				licenseName: "Apache 2.0",
				projectLink: "https://github.com/localForage/localForage",
				projectName: "localForage",
			},
			{
				licenseLink: "https://github.com/gomarkdown/markdown/blob/master/LICENSE.txt",
				licenseName: "BSD",
				projectLink: "https://github.com/gomarkdown/markdown",
				projectName: "Markdown Parser and HTML Renderer for Go",
			},
			{
				licenseLink: "https://github.com/markdown-it/markdown-it/blob/master/LICENSE",
				licenseName: "MIT",
				projectLink: "https://github.com/markdown-it/markdown-it",
				projectName: "markdown-it",
			},
			{
				licenseLink: "https://github.com/MithrilJS/mithril.js/blob/next/LICENSE",
				licenseName: "MIT",
				projectLink: "https://mithril.js.org/",
				projectName: "Mithril",
			},
			{
				licenseLink: "https://github.com/moment/moment-timezone/blob/develop/LICENSE",
				licenseName: "MIT",
				projectLink: "https://github.com/moment/moment-timezone",
				projectName: "moment-timezone",
			},
			{
				licenseLink: "https://github.com/soldair/node-qrcode/blob/master/license",
				licenseName: "MIT",
				projectLink: "https://github.com/soldair/node-qrcode",
				projectName: "node-qrcode",
			},
			{
				licenseLink: "https://github.com/Leonidas-from-XIV/node-xml2js/blob/master/LICENSE",
				licenseName: "MIT",
			...
			{
				licenseLink: "https://github.com/open-telemetry/opentelemetry-js/blob/main/LICENSE",
				licenseName: "Apache 2.0",
				projectLink: "https://github.com/open-telemetry/opentelemetry-js",
				projectName: "OpenTelemetry JavaScript Client",
			},
			{
				licenseLink: "https://github.com/open-telemetry/opentelemetry-go/blob/main/LICENSE",
				licenseName: "Apache 2.0",
			...
			{
				licenseLink: "https://github.com/hectorm/otpauth/blob/master/LICENSE.md",
				licenseName: "MIT",
			...
			{
				licenseLink: "https://github.com/prometheus/client_golang/blob/master/LICENSE",
				licenseName: "Apache 2.0",
			...
			{
				licenseLink: "https://github.com/browserify/stream-browserify/blob/master/LICENSE",
				licenseName: "MIT",
				projectLink: "https://github.com/browserify/stream-browserify",
				projectName: "stream-browserify",
			},
			{
				licenseLink: "https://github.com/naptha/tesseract.js/blob/master/LICENSE.md",
				licenseName: "Apache 2.0",
