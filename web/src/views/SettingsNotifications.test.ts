...
test("SettingsNotifications", async () => {
	...
	testing.text("#table-data-smith-family-task-reminders-type", "Smith Family Task Reminders");
	...
	// Device clicking
	testing.text("#table-data-doe-family-task-reminders-type", "Doe Family Task Reminders");
	...
	await testing.sleep(100);
	testing.text("#table-data-doe-family-task-reminders-device", "check_box_outline_blank");
});
