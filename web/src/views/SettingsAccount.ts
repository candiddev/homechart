...
import {
  OIDCProviderType,
  OIDCProviderTypeEnum,
} from "@lib/types/OIDCProviderType";
import {
  ActionCancel,
  ActionUpdate,
...
import {
  ObjectAccount,
  WebFormContactUsButtonFeedback,
  ...
  WebGlobalSettings,
  WebGlobalTOTPCode,
  WebGlobalTOTPCodeTooltip,
  WebGlobalUsername,
  WebSettingsAccountDeleteAccount,
  WebSettingsAccountDeleteAccountConfirm,
  WebSettingsAccountDisableTOTP,
  WebSettingsAccountPrivateKey,
  WebSettingsAccountPrivateKeyAdd,
  WebSettingsAccountPrivateKeyLock,
  WebSettingsAccountPrivateKeyName,
  WebSettingsAccountPrivateKeyPassphraseRemember,
  WebSettingsAccountPrivateKeyPassphrases,
  WebSettingsAccountPrivateKeyReset,
  WebSettingsAccountPrivateKeyResetConfirm1,
  WebSettingsAccountPrivateKeyResetConfirm2,
  WebSettingsAccountPrivateKeyResetConfirm3,
  WebSettingsAccountPrivateKeyUnlock,
  WebSettingsAccountPrivateKeyUnlockFail,
  WebSettingsAccountRemoveSignIn,
  WebSettingsAccountSecurity,
  WebSettingsAccountSetupTOTP,
  WebSettingsAccountShowBackupCode,
  WebSettingsAccountTOTPBackupCode,
  WebSettingsAccountTOTPSecretEntry,
} from "../yaml8n";
                ...
                ? [
                    {
                      ...
                      permitted:
                        ...
                        !AuthAccountState.data().verified &&
                  ...
                  ? [
                      {
                        ...
                        permitted:
                          ...
                          AuthAccountState.data().oidcProviderType !==
                            OIDCProviderTypeEnum.None &&
                          !state.formPasswordShow,
                        requireOnline: true,
                      },
                      {
                        accent: true,
                      ...
                      },
                      {
                        ...
                        onclick: async (): Promise<void | Err> => {
                          return AuthAccountState.readTOTPBackup().then(
                            (data) => {
                              if (!IsErr(data)) {
                      ...
                      },
                      {
                        ...
                        onclick: async (): Promise<void | Err> => {
                          return AuthAccountState.createTOTP().then((data) => {
                            if (!IsErr(data)) {
                      ...
                      },
                      {
                        ...
                        onclick: async (): Promise<void> => {
                          return AuthAccountState.updateTOTP(authAccount).then(
                            () => {
                    ...
                    ? [
                        ...
                        },
                        {
                          ...
                          onclick: async (): Promise<void> => {
                            ...
                            const members = AuthHouseholdState.members().filter(
                              (member) => {
                            ...
                            if (
                              ...
                              await PaymentState.cancel(
                                AuthAccountState.data().primaryAuthHouseholdID,
                              );
                            }

                            return AuthAccountState.delete().then(async () => {
            ...
            onsubmit: async () => {
              switch (state.tab) {
                ...
                case tabs.security:
                  ...
                  return AuthAccountState.update(authAccount).then(() => {
            ...
            : state.tab === tabs.components
              ...
              : state.tab === tabs.security
                ? [
                              ...
                              },
                              {
                                ...
                                onclick: async (): Promise<void | Err> => {
                                  ...
                                  if (
                                    ...
                                    return AuthAccountState.newPrivatePublicKey(
                                      `${AuthAccountState.translate(WebSettingsAccountPrivateKeyName)} ${AppState.formatCivilDate(CivilDate.now())}`,
                                      state.passphrase,
                                    ).then(() => {
                                      setLayoutApp();
                                    });
                                  ...
                                  return AuthAccountState.decryptPrivateKeys(
                                    state.passphrase,
                                  ).then(async () => {
                                    if (
                                      AuthAccountState.privateKey().key === ""
                      ...
                      : m(Table, {
                          ...
                          editOnclick: (s: AuthAccountPrivateKey) => {
                            AppState.setLayoutAppForm(
                              FormOverlayAuthAccountPrivateKey,
                              s,
                            );
                          },
                          filters: [],
                    ...
                    AuthAccountState.data().oidcProviderType ===
                      OIDCProviderTypeEnum.None || state.formPasswordShow
                      ? [
                          m(Title, {
                            name: AuthAccountState.translate(
                              FormItemNewPasswordPassword,
