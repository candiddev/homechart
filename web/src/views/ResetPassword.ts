...
import { WebGlobalActionResend, WebGlobalActionResetPassword, WebGlobalActionSignUp, WebGlobalEmailAddress, WebGlobalPasswordShow, WebResetEmailAddressTooltip } from "../yaml8n";
			...
			return m(Form, {
				...
				onsubmit: async () => {
					return AuthAccountState.updateReset(state.form)
						.then(async () => {
							return AuthAccountState.createSession(state.form, await API.getHostname());
						})
						.then(async () => {
