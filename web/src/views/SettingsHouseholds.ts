...
import { ObjectHouseholds, WebAdminHouseholdsMemberCount, WebGlobalName, WebGlobalPrimary, WebGlobalSettings } from "../yaml8n";
				...
				m(FormJoinHousehold,
					m(Table, {
						...
						tableColumns: [
							...
							{
								checkboxOnclick: async (data: AuthHousehold): Promise<void | Err> => {
								...
								formatter: (a: AuthHousehold): boolean => {
									return AuthAccountState.data().primaryAuthHouseholdID === a.id;
								},
