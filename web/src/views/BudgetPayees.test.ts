...
test("BudgetPayees", async () => {
	...
	testing.text(`#table-data-${seed.budgetPayees[1].id}-budgettransactionamount`, Currency.toString(seed.budgetPayees[1].budgetTransactionAmount, AuthHouseholdState.data()[0].preferences.currency));
