...
import {
  WebFeatureVotingComment,
  WebFeatureVotingCommentTooltip,
  WebFeatureVotingDescription,
  WebFeatureVotingSubtitle1,
  WebFeatureVotingSubtitle2,
  WebFeatureVotingVotes,
  WebFeatureVotingVotesTooltip,
      ...
      return [
                ...
                buttons: [
                  ...
                  },
                  {
                    ...
                    onclick: async (): Promise<void> => {
                      ...
                      return AuthHouseholdState.update(ah).then(() => {
                        formState.visible = false;
                      });
                    },
                    permitted: true,
        ...
        m(Table, {
          ...
          editOnclick: (s: string) => {
            ...
            const vi = AuthHouseholdState.findID(id).featureVotes.findIndex(
              (vote) => {
          ...
          tableColumns: [
            ...
            },
            {
              formatter: (e: string): string => {
                ...
                if (AppState.isSessionAdmin()) {
                  const vi = AdminFeatureVoteState.data().findIndex((vote) => {
                    return vote.feature === i;
                  });
                ...
                if (
                  AuthHouseholdState.findID(id).featureVotes[vi] !== undefined
                ) {
                  amount =
                    AuthHouseholdState.findID(id).featureVotes[vi].amount;
                }
            ...
            },
            {
              formatter: (e: string): string => {
                ...
                if (AppState.isSessionAdmin()) {
                  ...
                  const vi = AuthHouseholdState.findID(
                    id,
                  ...
                  if (
                    ...
                    return AuthHouseholdState.findID(id).featureVotes[vi]
                      .comment;
                  }
                }
