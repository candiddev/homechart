...
import {
  ...
  WebGlobalName,
  WebShopCategoriesMatchOutput,
  WebShopCategoriesTest,
  WebShopCategoriesTestTooltip,
} from "../yaml8n";
  ...
  return {
    oninit: async (): Promise<void> => {
      ...
      AppState.setLayoutApp({
        ...
        toolbarActionButtons: [AppToolbarActions().newShopCategory],
      });
    },
    onremove: (): void => {
      data.end(true);
