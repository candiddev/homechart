...
describe("FormSubscription", () => {
  ...
  test("cloud", async () => {
    ...
    testing.mocks.responses = [
      {
        ...
        dataValue: [seed.authHouseholds[1]],
      },
      {
        dataType: "AuthHousehold",
        dataValue: [seed.authHouseholds[1]],
    ...
    testing.text(
      "#form-item-input-subscription-expires",
      CivilDate.fromString(seed.authHouseholds[1].subscriptionExpires).toString(
        seed.authAccounts[3].preferences.formatDateOrder,
        seed.authAccounts[3].preferences.formatDateSeparator,
      ),
    );
    ...
    testing.text(
      "#referral",
      "You've referred 3 so far.  Refer 7 more to subscribe to Homechart and receive a free lifetime subscription!  The users you refer get a free month.  Here's a link for social media: https://web.homechart.app/signup?referral=123",
    );
