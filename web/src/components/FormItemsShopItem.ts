...
import {
  ...
  ObjectRecipe,
  ObjectStore,
  WebFormItemsShopItemCategoryTooltip,
  WebFormItemsShopItemListTooltip,
  WebFormItemsShopItemMakeStaple,
  WebFormItemsShopItemPrice,
  WebFormItemsShopItemPriceTooltip,
  WebFormItemsShopItemPurchaseOnTooltip,
  WebFormItemsShopItemStoreTooltip,
  WebGlobalName,
      ...
      return [
              ...
              select: {
                oninput: (e: string): void => {
                  if (e === "") {
                    ...
                    vnode.attrs.data.budgetPayeeID = ShopCategoryState.findID(
                      vnode.attrs.data.shopCategoryID,
                    ).budgetPayeeID;
                  }
                },
                options: ["", ...ShopCategoryState.data()],
                required: false,
        ...
        AuthAccountState.data().primaryAuthHouseholdID === null
          ...
          : m(FormItem, {
              ...
              select: {
                oninput: (e: string): void => {
                  vnode.attrs.data.budgetPayeeID =
                    BudgetPayeeState.findName(e).id;
                },
            ...
            oninput: (e: string): void => {
              if (e === "Pick Up" || e === "") {
                ...
                vnode.attrs.data.authAccountID =
                  ShopListState.findID(e).authAccountID;
                vnode.attrs.data.authHouseholdID =
                  ShopListState.findID(e).authHouseholdID;
              }
            },
            options: [
              {
        ...
        vnode.attrs.data.cookMealPlanID === null
          ...
          : m(FormItem, {
              input: {
                ...
                oninput: (): void => {},
                type: "text",
                value: `${CivilDate.fromString(
                  CookMealPlanState.findID(vnode.attrs.data.cookMealPlanID)
                    .date as string,
                ).toString(
                  AuthAccountState.data().preferences.formatDateOrder,
                  AuthAccountState.data().preferences.formatDateSeparator,
                )} - ${CookMealTimeState.findID(CookMealPlanState.findID(vnode.attrs.data.cookMealPlanID).cookMealTimeID).name}`,
              },
        ...
        vnode.attrs.data.cookRecipeID === null
          ...
          : m(FormItem, {
              input: {
                ...
                oninput: (): void => {},
                type: "text",
                value: CookRecipeState.findID(vnode.attrs.data.cookRecipeID)
                  .name,
              },
        ...
        m(FormCheckbox, {
          ...
          onclick: () => {
            if (vnode.attrs.data.recurrence === null) {
              vnode.attrs.data.nextDate = CivilDate.now().toJSON();
