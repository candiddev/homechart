...
import { ObjectParentProject, ObjectProject, WebFormItemPlanProjectParentTooltip, WebFormItemPlanProjectTooltip } from "../yaml8n";
	...
	return {
		...
		view: (vnode): m.Children => {
			return m(FormItemSelectNested, {
				name: vnode.attrs.planProjectID === undefined ?
				...
				onselect: (e: string): void => {
					...
					case "personal":
						...
						break;
					case "household":
						vnode.attrs.authHouseholdID = AuthAccountState.data().primaryAuthHouseholdID;
						vnode.attrs.parentID = null;
						if (vnode.attrs.planProjectID === undefined) {
					...
					default:
						...
						if (vnode.attrs.planProjectID === undefined) {
							...
							if (project.authAccountID !== null && vnode.attrs.authAccountID !== project.authAccountID) { // keep the task assignee, if project is a household project
								vnode.attrs.authAccountID = project.authAccountID;
							}
							vnode.attrs.parentID = null;
				...
				options: vnode.attrs.oninput === undefined ?
				...
				tooltip: vnode.attrs.planProjectID === undefined ?
					AuthAccountState.translate(WebFormItemPlanProjectParentTooltip):
					AuthAccountState.translate(WebFormItemPlanProjectTooltip),
				value: vnode.attrs.planProjectID !== undefined && vnode.attrs.planProjectID === null || vnode.attrs.planProjectID === undefined && vnode.attrs.parentID === null ?
					vnode.attrs.authHouseholdID === null ?
						vnode.attrs.authAccountID === null ?
							null : // null for value
							"personal" :
