		...
		view: (vnode): m.Children => {
			return Translations.permissions.map((permission) => {
				...
				return m(FormItem, {
					...
					select: {
						disabled: vnode.attrs.limit === true && initPermissions[Permission.components[permission.component]] === 2,
						oninput: (e: string): void => {
							vnode.attrs.permissions[Permission.components[permission.component]] = AppState.data.translations.formPermissionTypes.indexOf(e);
							if (AppState.data.translations.formPermissionTypes.indexOf(e) > 0) {
								vnode.attrs.permissions.auth = 1;
							}
							m.redraw();
						},
						options: vnode.attrs.limit === true ?
							AppState.data.translations.formPermissionTypes.slice(initPermissions[Permission.components[permission.component]], permission.component === PermissionComponentsEnum.Auth ?
						...
						value: AppState.data.translations.formPermissionTypes[vnode.attrs.permissions[Permission.components[permission.component]]],
					},
