...
import {
  ...
  WebGlobalName,
  WebGlobalTimeZone,
  WebSettingsAccountAccentColor,
  WebSettingsAccountColorTheme,
  WebSettingsAccountDarkMode,
  WebSettingsAccountDateOrder,
  WebSettingsAccountDateOrderTooltip,
  WebSettingsAccountDateSeparator,
  WebSettingsAccountDateSeparatorTooltip,
  WebSettingsAccountEmailAddressTooltip,
  WebSettingsAccountLanguageDateTime,
  WebSettingsAccountLanguageTooltip,
  WebSettingsAccountNameTooltip,
  WebSettingsAccountNegativeColor,
  WebSettingsAccountPositiveColor,
  WebSettingsAccountPrimaryColor,
  WebSettingsAccountRandomizeColors,
  WebSettingsAccountSecondaryColor,
  WebSettingsAccountStartWeek,
  WebSettingsAccountStartWeekTooltip,
  WebSettingsAccountTimeFormat,
  WebSettingsAccountTimeFormatTooltip,
  WebSettingsAccountTimeZoneTooltip,
} from "../yaml8n";
...
export function FormAuthAccountPreferences(): m.Component<FormAuthAccountPreferencesAttrs> {
  ...
  return {
    oninit: async (): Promise<void> => {
      ...
      timezones = tz.names().map((t: string) => {
        return {
          id: t,
          name: `${t.replace(/_/g, " ")} (${tz(t).format("hh:mm A")})`,
        };
      });
    },
          ...
          ? [
              m(FormItem, {
                ...
                select: {
                  ...
                  options: Object.keys(ISO639Codes).map((key) => {
                    return {
                      id: key,
              ...
              m(FormItem, {
                ...
                select: {
                  ...
                  value:
                    dateOrder[
                      vnode.attrs.authAccount.preferences.formatDateOrder
                    ],
                },
                tooltip: AuthAccountState.translate(
                  WebSettingsAccountDateOrderTooltip,
              ...
              m(FormItem, {
                ...
                select: {
                  oninput: (e: string): void => {
                    vnode.attrs.authAccount.preferences.formatDateSeparator =
                      CivilDateSeparator.indexOf(e);
                    ...
                    (
                      document.getElementById(
                        `form-item-select${StringToID(AuthAccountState.translate(WebSettingsAccountDateOrder))}`,
                      ) as HTMLInputElement
                    ).value =
                      dateOrder[
                        vnode.attrs.authAccount.preferences.formatDateOrder
              ...
              m(FormItem, {
                ...
                select: {
                  oninput: (e: string): void => {
                    vnode.attrs.authAccount.preferences.formatWeek8601 =
                      e === "yes";
                  },
                  options: [
                    {
              ...
              m(FormItem, {
                ...
                select: {
                  oninput: (e: string): void => {
                    vnode.attrs.authAccount.preferences.formatTime24 =
                      e === "21:00";
                  },
                  options: ["21:00", "9:00 PM"],
        ...
        expandColor
          ? [
              m(FormCheckbox, {
                ...
                onclick: () => {
                  vnode.attrs.authAccount.preferences.darkMode =
                    !vnode.attrs.authAccount.preferences.darkMode;
                  AuthAccountState.data({
                    ...AuthAccountState.data(),
                    ...{
                  ...
                  AuthAccountState.data({
                    ...
                    ...{
                      preferences: {
                        ...AuthAccountState.data().preferences,
                        colorPrimary:
                          vnode.attrs.authAccount.preferences.colorPrimary,
                      },
                    },
                  });
                  m.redraw();
                  ...
                  AuthAccountState.data({
                    ...
                    ...{
                      preferences: {
                        ...AuthAccountState.data().preferences,
                        colorSecondary:
                          vnode.attrs.authAccount.preferences.colorSecondary,
                      },
                    },
                  });
                  m.redraw();
                  ...
                  AuthAccountState.data({
                    ...
                    ...{
                      preferences: {
                        ...AuthAccountState.data().preferences,
                        colorAccent:
                          vnode.attrs.authAccount.preferences.colorAccent,
                      },
                    },
                  });
                  m.redraw();
                  ...
                  AuthAccountState.data({
                    ...
                    ...{
                      preferences: {
                        ...AuthAccountState.data().preferences,
                        colorPositive:
                          vnode.attrs.authAccount.preferences.colorPositive,
                      },
                    },
                  });
                  m.redraw();
                  ...
                  AuthAccountState.data({
                    ...
                    ...{
                      preferences: {
                        ...AuthAccountState.data().preferences,
                        colorNegative:
                          vnode.attrs.authAccount.preferences.colorNegative,
                      },
                    },
                  });
                  m.redraw();
              ...
              m(Button, {
                ...
                onclick: async (): Promise<void> => {
                  return new Promise((resolve) => {
                    ...
                    vnode.attrs.authAccount.preferences.colorAccent =
                      Object.keys(ColorEnum)[accent];
                    vnode.attrs.authAccount.preferences.colorPrimary =
                      Object.keys(ColorEnum)[primary];
                    vnode.attrs.authAccount.preferences.colorSecondary =
                      Object.keys(ColorEnum)[secondary];
