...
import { ObjectMealTime, WebFormOverlayCookMealTimeTime, WebFormOverlayCookMealTimeTimeTooltip, WebGlobalName, WebGlobalNameTooltip } from "../yaml8n";

export function FormOverlayCookMealTime (): m.Component<FormOverlayComponentAttrs<CookMealTime>> {
	return {
		...
		view: (vnode): m.Children => {
			return m(FormOverlay, {
				...
				m(FormItem, {
					...
					tooltip: AuthAccountState.translate(WebFormOverlayCookMealTimeTimeTooltip),
				}),
			]);
		},
	};
