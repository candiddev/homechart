...
import { ObjectCard, ObjectReward, WebFormOverlayRewardCardAlwaysRedeemable, WebFormOverlayRewardCardRecipients, WebFormOverlayRewardCardRecipientsTooltip, WebFormOverlayRewardCardRewardStampCount, WebFormOverlayRewardCardRewardStampCountTooltip, WebFormOverlayRewardCardRewardStampGoal, WebFormOverlayRewardCardRewardStampGoalTooltip, WebFormOverlayRewardCardRewardTooltip, WebFormOverlayRewardCardSenders, WebFormOverlayRewardCardSendersTooltip, WebGlobalDetails, WebGlobalDetailsTooltips, WebGlobalName, WebGlobalNameTooltip } from "../yaml8n";

export function FormOverlayRewardCard (): m.Component<FormOverlayComponentAttrs<RewardCard>> {
	return {
		...
		view: (vnode): m.Children => {
			return m(FormOverlay, {
				...
				permitted: GlobalState.permitted(PermissionComponentsEnum.Reward, true, vnode.attrs.data.authHouseholdID),
			}, [
				m(FormItem, {
					input: {
						oninput: (e) => {
				...
				m(FormCheckbox, {
					name: AuthAccountState.translate(WebFormOverlayRewardCardAlwaysRedeemable),
					onclick: () => {
				...
				m(FormItem, {
					...
					tooltip: AuthAccountState.translate(WebFormOverlayRewardCardRewardTooltip),
				}),
				m(FormItem, {
					input: {
						oninput: (e) => {
					...
					name: vnode.attrs.data.invert ?
						AuthAccountState.translate(WebFormOverlayRewardCardRewardStampCount) :
						AuthAccountState.translate(WebFormOverlayRewardCardRewardStampGoal),
					tooltip: vnode.attrs.data.invert ?
						AuthAccountState.translate(WebFormOverlayRewardCardRewardStampCountTooltip) :
						AuthAccountState.translate(WebFormOverlayRewardCardRewardStampGoalTooltip),
				}),
				m(FormItemSelectAuthHouseholdMembers, {
					...
					tooltip: AuthAccountState.translate(WebFormOverlayRewardCardSendersTooltip),
				}),
				m(FormItemSelectAuthHouseholdMembers, {
					authHouseholdID: vnode.attrs.data.authHouseholdID,
					members: vnode.attrs.data.recipients,
					multiple: true,
					name: AuthAccountState.translate(WebFormOverlayRewardCardRecipients),
					oninput: (members: string[]) => {
						vnode.attrs.data.recipients = members;
					},
					tooltip: AuthAccountState.translate(WebFormOverlayRewardCardRecipientsTooltip),
				}),
			]);
		},
	};
