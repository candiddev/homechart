...
import {
  ...
  ObjectItem,
  ObjectTask,
  WebFormOverlayPlanTaskAssignees,
  WebFormOverlayPlanTaskAssigneesTooltip,
  WebFormOverlayPlanTaskDueDate,
  WebFormOverlayPlanTaskDueDateTooltip,
  WebFormOverlayPlanTaskDuration,
  WebFormOverlayPlanTaskDurationTooltip,
  WebFormOverlayPlanTaskInventoryItemTooltip,
  WebFormOverlayPlanTaskLastDone,
  WebFormOverlayPlanTaskRecurComplete,
  WebFormOverlayPlanTaskReminder,
  WebFormOverlayPlanTaskReminderTooltip,
  WebFormOverlayPlanTaskTemplate,
  WebFormOverlayPlanTaskTemplateGlobal,
  WebGlobalActionCopy,
  WebGlobalCompleted,
  WebGlobalDetails,
...
export function FormOverlayPlanTask(): m.Component<
  FormOverlayComponentAttrs<PlanTask>
> {
  return {
        ...
        [
          ...
          vnode.attrs.data.authHouseholdID === null
            ...
            : m(FormItemSelectAuthHouseholdMembers, {
                ...
                members:
                  vnode.attrs.data.assignees.length === 0 &&
                  vnode.attrs.data.authAccountID !== null
                ...
                oninput: (members: string[]) => {
                  ...
                  if (members.length > 0) {
                    ...
                    vnode.attrs.data.color = AuthHouseholdState.findMember(
                      members[0],
                    ).color;
                  } else {
                    vnode.attrs.data.authAccountID = null;
          ...
          InventoryItemState.data().length > 0
            ? m(FormItem, {
                ...
                select: {
                  ...
                  options: ["", ...InventoryItemState.data()],
                  required: false,
            ...
            : [
                m(FormItemInputDate, {
                  ...
                  oninput: (e: string): void => {
                    ...
                    vnode.attrs.data.dueDate = new Date(
                      `${e}T${date.toCivilTime().toString(true)}`,
                    ).toISOString();
                  },
                  tooltip: AuthAccountState.translate(
                    WebFormOverlayPlanTaskDueDateTooltip,
                  ...
                  : m(FormItem, {
                      input: {
                        oninput: (e: string): void => {
                          if (vnode.attrs.data.dueDate !== null) {
                            if (e === "") {
                              const timestamp = Timestamp.fromString(
                                vnode.attrs.data.dueDate,
                              );
                  ...
                  : [
                      ...
                      m(FormItem, {
                        input: {
                          ...
                          type: "text",
                          value:
                            vnode.attrs.data.lastDoneBy !== null &&
                            vnode.attrs.data.lastDoneDate !== null
                              ? `${CivilDate.fromString(
                                  vnode.attrs.data.lastDoneDate,
                                ).toString(
                                  AuthAccountState.data().preferences
                                    .formatDateOrder,
                                  AuthAccountState.data().preferences
                                    .formatDateSeparator,
                                )} by ${AuthHouseholdState.findMemberName(vnode.attrs.data.lastDoneBy)}`
