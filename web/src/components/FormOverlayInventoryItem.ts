...
import {
  ObjectItem,
  WebFormOverlayInventoryItemAssociatedTasks,
  WebFormOverlayInventoryItemProperties,
  WebFormOverlayInventoryItemPropertiesTooltip,
  WebFormOverlayInventoryItemProperty,
  WebFormOverlayInventoryItemQuantity,
  WebFormOverlayInventoryItemQuantityTooltip,
  WebFormOverlayInventoryItemUPC,
  WebFormOverlayInventoryItemUPCTooltip,
  WebGlobalImage,
  WebGlobalName,
...
export function FormOverlayInventoryItem(): m.Component<
  FormOverlayComponentAttrs<InventoryItem>
> {
  return {
    ...
    oninit: async (vnode): Promise<void> => {
      if (
        ...
        vnode.attrs.data.qrlink = InventoryItemState.getLink(
          vnode.attrs.data.id,
        );
      ...
      return m(
        ...
        [
          ...
          m(FormItemInputProperties, {
            ...
            nameSingle: AuthAccountState.translate(
              WebFormOverlayInventoryItemProperty,
            ),
