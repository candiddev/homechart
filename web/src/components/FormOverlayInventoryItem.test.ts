...
test("FormOverlayInventoryItem", async () => {
	...
	await testing.sleep(100);
	expect(inventoryItem.properties)
		.toStrictEqual({
			Brand: "test",
		});
