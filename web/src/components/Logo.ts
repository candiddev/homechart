          ...
          : m.route.Link,
        {
          ...
          href:
            vnode.attrs.link === undefined
              ...
              : vnode.attrs.link,
          id: "homechart-logo",
          rel: vnode.attrs.link === undefined ? "noopener" : undefined,
          target: vnode.attrs.link === undefined ? "_blank" : undefined,
        },
        [
          m("img.Logo__img", {
            alt: "Homechart",
          ...
          vnode.attrs.noTitle === true ? [] : m("p.Logo__name", "Homechart"),
        ],
      );
    },
  };
